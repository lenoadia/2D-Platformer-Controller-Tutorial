...
public class BasicEnemyController : MonoBehaviour
{
    ...
    private void CheckTouchDamage()
    {
        ...
        {
            touchDamageBotLeft.Set(touchDamageCheck.position.x - (touchDamageWidht / 2), touchDamageCheck.position.y - (touchDamageHeight / 2));
            touchDamageTopRight.Set(touchDamageCheck.position.x + (touchDamageWidht / 2), touchDamageCheck.position.y + (touchDamageHeight / 2));
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector2 botLeft = new Vector2(touchDamageCheck.position.x - (touchDamageWidht / 2), touchDamageCheck.position.y - (touchDamageHeight / 2));
        Vector2 botRight = new Vector2(touchDamageCheck.position.x + (touchDamageWidht / 2), touchDamageCheck.position.y - (touchDamageHeight / 2));
        Vector2 topRight = new Vector2(touchDamageCheck.position.x + (touchDamageWidht / 2), touchDamageCheck.position.y + (touchDamageHeight / 2));
        Vector2 topLeft = new Vector2(touchDamageCheck.position.x - (touchDamageWidht / 2), touchDamageCheck.position.y + (touchDamageHeight / 2));
